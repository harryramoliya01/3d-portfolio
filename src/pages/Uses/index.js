              ...
              <ProjectSectionText>
                <ul>
                  <li>
                    ...
                    looked back. I've also created a few plugins that
                    you can install.
                  </li>
                  <li>
                    Any motion graphics I create are created in Adobe After Effects, and Adobe Animate. So
                    far I haven't found a non-Adobe product that's as good. If anyone has
                    suggestions please <Link href="/contact">message me</Link>.
                  </li>
                  <li>
                    For any 3D models I use{' '}
                    <Link href="https://www.blender.org/">Blender</Link> and <Link href="https://www.maxon.net/en/cinema-4d">Maxon Cinema 4D</Link>. Since 2.8 it's
                    become way simpler to use and in a lot of ways better than expensive
                    paid tools like <Link href="https://en.wikipedia.org/wiki/Autodesk_3ds_Max"> </Link>3DS Max or Maya.
                  </li>
                </ul>
              </ProjectSectionText>
            </ProjectTextRow>
